  let comments = [];
    ...
    function createCommentCard(comment) {
        ...
        header.classList.add('flex', 'items-center', 'space-x-4', 'flex-wrap');
        ...
        buttonContainer.classList.add('flex', 'space-x-4', 'mt-2', 'flex-wrap', 'gap-2');
    
        const replyButton = document.createElement('button');
        replyButton.classList.add('bg-blue-500', 'text-white', 'px-4', 'py-2', 'rounded-full', 'hover:bg-blue-600', 'w-full', 'sm:w-auto');
        replyButton.textContent = 'Reply';
        replyButton.addEventListener('click', () => showReplyInput(comment.id));
    
        const editButton = document.createElement('button');
        editButton.classList.add('bg-yellow-500', 'text-white', 'px-4', 'py-2', 'rounded-full', 'hover:bg-yellow-600', 'w-full', 'sm:w-auto');
        editButton.textContent = comment.isEditing ? 'Save' : 'Edit';
        editButton.addEventListener('click', () => editComment(comment.id));
    
        const deleteButton = document.createElement('button');
        deleteButton.classList.add('bg-red-500', 'text-white', 'px-4', 'py-2', 'rounded-full', 'hover:bg-red-600', 'w-full', 'sm:w-auto');
        ...
        // Create the replies section
        const repliesSection = document.createElement('div');
        repliesSection.classList.add('ml-10', 'space-y-4', 'mt-4');
    ...
    function showReplyInput(commentId) {
      ...
      if (!replyInputSection) {
        ...
        replyTextInput.placeholder = 'Write your reply here...';
        ...
        replyButton.textContent = 'Reply';
        replyButton.addEventListener('click', () => addComment(commentId));
